...
type UserQuery struct {
	...
	withGoogleOauthTokens *GoogleOauthTokenQuery
...
// QueryGoogleOauthTokens chains the current query on the "google_oauth_tokens" edge.
func (uq *UserQuery) QueryGoogleOauthTokens() *GoogleOauthTokenQuery {
	query := (&GoogleOauthTokenClient{config: uq.config}).Query()
...
// QueryGoogleOauthStates chains the current query on the "google_oauth_states" edge.
func (uq *UserQuery) QueryGoogleOauthStates() *GoogleOauthStateQuery {
	query := (&GoogleOauthStateClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryExternalCalendars chains the current query on the "external_calendars" edge.
func (uq *UserQuery) QueryExternalCalendars() *ExternalCalendarQuery {
	query := (&ExternalCalendarClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withGoogleOauthTokens: uq.withGoogleOauthTokens.Clone(),
		withGoogleOauthStates: uq.withGoogleOauthStates.Clone(),
		withEvents:            uq.withEvents.Clone(),
		withExternalCalendars: uq.withExternalCalendars.Clone(),
...
// WithGoogleOauthTokens tells the query-builder to eager-load the nodes that are connected to
// the "google_oauth_tokens" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithGoogleOauthTokens(opts ...func(*GoogleOauthTokenQuery)) *UserQuery {
	query := (&GoogleOauthTokenClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withGoogleOauthTokens = query
	return uq
}

// WithGoogleOauthStates tells the query-builder to eager-load the nodes that are connected to
// the "google_oauth_states" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithGoogleOauthStates(opts ...func(*GoogleOauthStateQuery)) *UserQuery {
	query := (&GoogleOauthStateClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withGoogleOauthStates = query
	return uq
}
...
// WithExternalCalendars tells the query-builder to eager-load the nodes that are connected to
// the "external_calendars" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithExternalCalendars(opts ...func(*ExternalCalendarQuery)) *UserQuery {
	query := (&ExternalCalendarClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withExternalCalendars = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withGoogleOauthTokens; query != nil {
		if err := uq.loadGoogleOauthTokens(ctx, query, nodes, nil,
			func(n *User, e *GoogleOauthToken) { n.Edges.GoogleOauthTokens = e }); err != nil {
			return nil, err
		}
	}
	if query := uq.withGoogleOauthStates; query != nil {
		if err := uq.loadGoogleOauthStates(ctx, query, nodes, nil,
			func(n *User, e *GoogleOauthState) { n.Edges.GoogleOauthStates = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := uq.withExternalCalendars; query != nil {
		if err := uq.loadExternalCalendars(ctx, query, nodes, nil,
			func(n *User, e *ExternalCalendar) { n.Edges.ExternalCalendars = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadGoogleOauthTokens(ctx context.Context, query *GoogleOauthTokenQuery, nodes []*User, init func(*User), assign func(*User, *GoogleOauthToken)) error {
	...
	query.withFKs = true
	query.Where(predicate.GoogleOauthToken(func(s *sql.Selector) {
		s.Where(sql.InValues(user.GoogleOauthTokensColumn, fks...))
	}))
...
func (uq *UserQuery) loadGoogleOauthStates(ctx context.Context, query *GoogleOauthStateQuery, nodes []*User, init func(*User), assign func(*User, *GoogleOauthState)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.GoogleOauthState(func(s *sql.Selector) {
		s.Where(sql.InValues(user.GoogleOauthStatesColumn, fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
